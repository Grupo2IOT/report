...
- <strong>Enlace de video:</strong> [Video 1](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20221b490_upc_edu_pe/IQDMDQdLqakCTJsGhNQBFPbDAZuyXbkfBPyHMNfMpYh6MxU?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=xF3XNj) <br><small>URL: https://upcedupe-my.sharepoint.com/:v:/g/personal/u20221b490_upc_edu_pe/IQDMDQdLqakCTJsGhNQBFPbDAZuyXbkfBPyHMNfMpYh6MxU?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=xF3XNj</small>
- <strong>Foto del entrevistado:</strong><br><img src="./assets/entrevista1iot.png" alt="Entrevista_1" width="330"/>
...
- <strong>Enlace de video:</strong> [Video 2](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20221b490_upc_edu_pe/IQC7058PkkrUTKLWM4Drir24AW63MDYCR5EZduildrRTa1U?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=n7fhrv) <br><small>URL: https://upcedupe-my.sharepoint.com/:v:/g/personal/u20221b490_upc_edu_pe/IQC7058PkkrUTKLWM4Drir24AW63MDYCR5EZduildrRTa1U?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=n7fhrv</small>
- <strong>Foto del entrevistado:</strong><br><img src="./assets/entrevista-santiagoG.png" alt="Entrevista 2" width="330"/>
...
- <strong>Nombre:</strong> Valesca Quispe (Representando a Rafael Quispe)
- <strong>Edad:</strong> 50+ años (Rafael)
- <strong>Procedencia:</strong> Tambogrande, Piura
- <strong>Segmento:</strong> Pequeños y Medianos Agricultores (Usuario Final)
- <strong>Resumen:</strong> Valesca representó a su tío Rafael, quien cultiva 3.5 hectáreas de banano y limón y depende críticamente del reservorio Poechos. La entrevista confirmó que Rafael utiliza riego por gravedad basado puramente en la intuición y experiencia acumulada, ya que carece de herramientas de medición. Se identificó que la conectividad es nula en su parcela, lo que genera desconfianza hacia tecnologías convencionales que dependen de internet. Sin embargo, validó la solución de AquaEdge al saber que funciona sin Wi-Fi, destacando que el mayor beneficio sería la autonomía del riego para asegurar la supervivencia de sus cultivos y su capital familiar ante la sequía.
- <strong>Enlace de video:</strong> [Video 7](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202115357_upc_edu_pe/IQCXJcY0R1VNRIrktVGJ5A08AXdFcKlj0yslc2gAWdcIHn4?e=TgYKtm) <br><small>URL: https://upcedupe-my.sharepoint.com/:v:/g/personal/u202115357_upc_edu_pe/IQCXJcY0R1VNRIrktVGJ5A08AXdFcKlj0yslc2gAWdcIHn4?e=TgYKtm</small>
- <strong>Foto del entrevistado:</strong><br><img src="./assets/entrevista_7.png" alt="Rafael Quispe" width="330"/>
...
- <strong>Enlace de video:</strong> [Video 4](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20221b490_upc_edu_pe/IQAuyPvT7CXURoTXpQArPvxUAcaJnqvuP_HVGP5L_iE7PMQ?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=sWB09n) <br><small>URL: https://upcedupe-my.sharepoint.com/:v:/g/personal/u20221b490_upc_edu_pe/IQAuyPvT7CXURoTXpQArPvxUAcaJnqvuP_HVGP5L_iE7PMQ?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=sWB09n</small>
- <strong>Foto del entrevistado:</strong><br><img src="./assets/Entrevista_4.png" alt="Entrevista_4" width="330"/>
...
- <strong>Enlace de video:</strong> [Video 5](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20221b490_upc_edu_pe/IQB9Y_98nT8kTpDVjBSHxTJxAUOltZItvggYjjt5f-GKVkU?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=X0OCT5) <br><small>URL: https://upcedupe-my.sharepoint.com/:v:/g/personal/u20221b490_upc_edu_pe/IQB9Y_98nT8kTpDVjBSHxTJxAUOltZItvggYjjt5f-GKVkU?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=X0OCT5</small>
- <strong>Foto del entrevistado:</strong><br><img src="./assets/entrevista-brunoO.png" alt="xxx" width="330"/>
...
- <strong>Nombre:</strong> José Avendaño (Representando a Richard Avendaño)
- <strong>Edad:</strong> 45+ años (Richard)
- <strong>Procedencia:</strong> Piura
- <strong>Segmento:</strong> Juntas de Usuarios e Instituciones (Cliente B2B/B2G)
- <strong>Resumen:</strong> José representó a su padre Richard, Ingeniero Agrónomo y analista de riesgos con 20 años de experiencia en el sector agro-financiero. En la entrevista se destacó que la institución carece de herramientas de monitoreo en tiempo real, dependiendo de supervisiones físicas costosas, lentas e ineficientes. Richard señaló que el mal manejo del agua por parte de los agricultores eleva críticamente el riesgo de impago de los créditos debido a la pérdida de cosechas por estrés hídrico. Validó el uso de un Dashboard centralizado para fiscalizar el consumo a distancia y confirmó que las instituciones estarían dispuestas a financiar esta tecnología si garantiza datos confiables para reducir la incertidumbre crediticia.
- <strong>Enlace de video:</strong> [Video 8](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202115357_upc_edu_pe/IQCxS1R29OIiSKFL2KtUp2JcAQv2HYnPcNWW5zLTnGky3yo?e=Tx0S7G) <br><small>URL: https://upcedupe-my.sharepoint.com/:v:/g/personal/u202115357_upc_edu_pe/IQCxS1R29OIiSKFL2KtUp2JcAQv2HYnPcNWW5zLTnGky3yo?e=Tx0S7G</small>
- <strong>Foto del entrevistado:</strong><br><img src="./assets/entrevista_8.png" alt="Richard Avendaño" width="330"/>

</div>

### 2.2.3. Análisis de entrevistas

A partir de las entrevistas realizadas a los dos segmentos objetivo de nuestro proyecto, se ha procesado la información cualitativa para identificar patrones de comportamiento, necesidades y dolores (pain points). A continuación, se presenta el análisis estadístico y descriptivo de los hallazgos más relevantes que servirán de base para la construcción de nuestros _User Personas_.
...
- Perfil Demográfico y Background: Los entrevistados del segmento agrícola llevan más de 20 años en el sector, habiendo heredado el oficio. Su principal fuente de ingresos son cultivos vulnerables a la sequía, como el banano orgánico y el limón.

- Comportamiento Tecnológico: La mayoría posee un smartphone de gama de entrada, pero todos reportan que la cobertura de internet o datos celulares en sus parcelas es nula o intermitente. Sus canales principales de información son la radio local y WhatsApp (cuando están en el pueblo).

- Tareas y Frustraciones (Pain Points): Los entrevistados riegan sus cultivos calculando la humedad "al ojo" mediante métodos tradicionales (gravedad o inundación). Todos expresaron un nivel de frustración muy alto ("miedo a perder su capital") debido a las restricciones de agua impuestas por las autoridades.

- Validación de la Solución: Todos los agricultores validaron positivamente la necesidad de un sistema automatizado. Sin embargo, la característica más crítica para ellos es que el sistema no dependa de Wi-Fi. Esto justifica plenamente nuestra propuesta de utilizar Edge Computing para la toma de decisiones locales y LoRaWAN para la transmisión de datos a larga distancia.
...
- **Perfil Demográfico y Background:** Profesionales técnicos entre 30 y 45 años, con estudios superiores en ingeniería agrícola, agronomía o finanzas. Todos tienen la responsabilidad de garantizar que los recursos hídricos y económicos se utilicen eficientemente.

- **Comportamiento Tecnológico:** Todos utilizan computadoras, bases de datos institucionales y hojas de cálculo (Excel) en su día a día. Tienen un alto nivel de adopción digital en entornos de oficina.

- **Tareas y Frustraciones (Pain Points):** Todos coinciden en que el mayor obstáculo en su gestión es la falta de información en tiempo real sobre lo que ocurre en las parcelas. La mayoría considera que las auditorías presenciales son lentas, costosas y subjetivas, lo que incrementa el riesgo de otorgar créditos (o refinanciamientos) a parcelas que ya están perdidas por la sequía.

- **Validación de la Solución:** Todos los funcionarios validaron con gran interés la propuesta de un Dashboard Web centralizado. Afirmaron que visualizar datos precisos de humedad y consumo de agua recolectados por sensores IoT les permitiría eliminar las auditorías "a ciegas", agilizar la aprobación de créditos y mitigar el riesgo de impago en medio de la emergencia hídrica regional.
...
<p align="center">
	<img src="assets/evidencia_EventStorming.png" alt="EventStorming" width="700" />
</p>
