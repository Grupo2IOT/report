...
| **Sprint #**                    | Sprint 2                                                                                                                                                                                                                                                                    |
| ------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Sprint Planning Background**  | Reunión de planificación enfocada en la integración de los componentes del sistema AquaEdge. Se priorizó la implementación del simulador IoT, la comunicación con APIs REST, el refinamiento de la Landing Page, la documentación técnica y el despliegue de los servicios. |
| Date                            | 2026-05-15                                                                                                                                                                                                                                                                  |
| Time                            | 10:00 AM                                                                                                                                                                                                                                                                    |
| Location                        | Reunión virtual (Google Meet, WhatsApp y Trello)                                                                                                                                                                                                                            |
| Prepared By                     | Jiménez Rosas, Arturo Eduardo                                                                                                                                                                                                                                               |
| Attendees (to planning meeting) | Arevalo Meza, John Telesforo / Asmad Padilla, Fatima Andrea / Cabrera Buitrón, Diego Ivan / Castro Sanchez, Amir Gabriel / Prado Vargas, Mario Benjamin                                                                                                                     |
| Sprint 1 Review Summary         | Se completaron las funcionalidades principales de interfaz de usuario y se validó el MVP visual de la solución.                                                                                                                                                             |
| Sprint 1 Retrospective Summary  | Se identificó la necesidad de mejorar la integración entre frontend, backend y dispositivos IoT, así como fortalecer las pruebas de validación.                                                                                                                             |
| Sprint Goal                     | Integrar la solución IoT completa mediante simulación ESP32, APIs REST y despliegue de los componentes principales del ecosistema AquaEdge.                                                                                                                                 |
